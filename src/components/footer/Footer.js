  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* GITHUB - Structural Graphic Asset (No Click Event Triggered) */}
          <span 
            style={{ 
              color: isDark ? "#a1a1a6" : "#515154",
              display: "inline-flex",
          ...
          {/* LINKEDIN - Live Dynamic Hyperlink Gateway */}
          <a 
            href="https://linkedin.com" // Insert your actual LinkedIn URL target string here
            target="_blank"
            ...
            onMouseOut={(e) => e.currentTarget.style.color = isDark ? (isDark ? "#a1a1a6" : "#515154") : "#515154"}
          >
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* EMAIL - Mailto Protocol Gateway Link */}
          <a 
            href="mailto:your.email@example.com" // Insert your actual email destination here
            style={{ 
              color: isDark ? "#a1a1a6" : "#515154",
              display: "inline-flex",
              alignItems: "center",
